...
public class Register extends AppCompatActivity {
    EditText FirstName, LastName, Birthday, MobileNumber, Address, EmailAddress, Password, ConfirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Birthday = (EditText) findViewById(R.id.txtRegisterBirthday);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dataMap.put("Birthday", bday);
                dataMap.put("Mobile Number", mnumber);
                dataMap.put("Address", add);
                dataMap.put("Email", emailadd);
                dataMap.put("Password", pass);
                if(!TextUtils.isEmpty(fname) && !TextUtils.isEmpty(lname) && !TextUtils.isEmpty(mnumber) && !TextUtils.isEmpty(add)  && !TextUtils.isEmpty(emailadd) && !TextUtils.isEmpty(pass) && (pass.equals(cpass))){
                ...
                else if(TextUtils.isEmpty(fname) && !TextUtils.isEmpty(lname) && !TextUtils.isEmpty(mnumber) && !TextUtils.isEmpty(add) && !TextUtils.isEmpty(emailadd) && !TextUtils.isEmpty(pass)){
                ...
                else if(!TextUtils.isEmpty(fname) && !TextUtils.isEmpty(lname) && !TextUtils.isEmpty(mnumber) && !TextUtils.isEmpty(add) && !TextUtils.isEmpty(emailadd) && !TextUtils.isEmpty(pass) && (!pass.equals(cpass))){
